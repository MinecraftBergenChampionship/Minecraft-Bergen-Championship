...
public class SG {
    ...
    public void spawnPlayers() {
        ...
        for (Participant p : players.participants) {
            ...
            playersDead++;
            p.player.addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 60*20, 4, false, false));
        }
